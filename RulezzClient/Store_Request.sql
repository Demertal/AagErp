...
CREATE TABLE ExchangeRate(
	...
	CONSTRAINT UQ_Currency_Сourse UNIQUE (Title, Сourse)
)
GO
...
CREATE TABLE NomenclatureGroup(
	...
	CONSTRAINT UQ_Title_IdStore UNIQUE (Title, IdStore)
)
GO
...
CREATE TABLE NomenclatureSubGroup(
	...
	CONSTRAINT UQ_Title_IdNomenclatureGroup UNIQUE (Title, IdNomenclatureGroup)
)
GO
...
CREATE TABLE PropertyValue(
	...
	CONSTRAINT UQ_Value_IdPropertyName UNIQUE (Value, IdPropertyName)
)
GO
...
CREATE TABLE PropertyProduct(
	...
	CONSTRAINT UQ_IdProduct_IdPropertyValue UNIQUE (IdProduct, IdPropertyValue)
)
GO
