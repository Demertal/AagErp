...
//        private RevaluationProducts _revaluationProductsReports = new RevaluationProducts();
...
//        {
//            _barcode = "";
//            _revaluationProductsReports = new RevaluationProducts();
...
//                {
//                    _revaluationProductsReports.RevaluationProductsInfos.AddAsync(revaluationProductsInfo.RevaluationProductsInfo);
...
//                SqlRevaluationProductsReportRepository dbSet = new SqlRevaluationProductsReportRepository();
//                dbSet.AddAsync(_revaluationProductsReports);
...
//            InsertProduct((Product) obj.Content);
//        }
...
//        {
//            if (!(navigationContext.Parameters["RevaluationProducts"] is List<Product> revaluationProducts)) return;
