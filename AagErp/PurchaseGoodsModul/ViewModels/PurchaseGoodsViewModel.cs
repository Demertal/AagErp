...
//        private Purchase _report = new Purchase();
...
//                SelectedStore = ArrivalStore.FirstOrDefault();
//            }
//        }

//        private ObservableCollection<Counterparty> _suppliers = new ObservableCollection<Counterparty>();
//        public ObservableCollection<Counterparty> Suppliers
//        {
//            get => _suppliers;
//            set
//            {
...
//        private ObservableCollection<Currency> _exchangeRates = new ObservableCollection<Currency>();
...
//                {
//                    if (purchaseInfo.Currency.Title == "USD" && _report.Cost <= 0) return false;
...
//        public ArrivalStore SelectedStore
//        {
//            get => _report.ArrivalStore;
//            set
//            {
//                _report.ArrivalStore = value;
//                RaisePropertyChanged();
//                RaisePropertyChanged("IsValidate");
//            }
//        }

//        public Counterparty SelectedSupplier
//        {
//            get => _report.Counterparty;
//            set
//            {
//                _report.Counterparty = value;
//                RaisePropertyChanged();
//                RaisePropertyChanged("IsValidate");
//            }
//        }
...
//                RaisePropertyChanged();
//                RaisePropertyChanged("IsValidate");
//                PurchaseInfosViewModelPropertyChanged(this, new PropertyChangedEventArgs("Cost"));
//            }
//        }
...
//                foreach (var purchaseInfo in PurchaseInfos)
//                {
//                    if (purchaseInfo.Currency.Title == "ГРН")
//                    {
//                        total += purchaseInfo.PurchasePrice * purchaseInfo.Count;
//                    }
//                    else
//                    {
//                        total += purchaseInfo.PurchasePrice * purchaseInfo.Count * Cost;
//                    }
//                }
...
//                Currency = dbSetExchange.Load();
//                RaisePropertyChanged("Currency");
//                SQLCounterpartyRepository dbSetSuppliers = new SQLCounterpartyRepository();
...
//            SelectedSupplier = Suppliers.FirstOrDefault();
//            PurchaseInfos.Clear();
//            Cost = Currency.FirstOrDefault(e => e.Title == "USD")?.Cost ?? 0;
//            RaisePropertyChanged("PurchaseInfos");
...
//        {
//            if(!(obj.Content is Product)) return;
//            try
//            {
//                AddProduct((Product)obj.Content);
//            }
//            catch (Exception e)
//            {
...
//            if (purchaseStruct?.Currency == null)
//            {
//                if (purchaseStruct == null)
//                {
//                    purchaseStruct = new PurchaseStruct{PurchasePrice = 0};
//                }
//                purchaseStruct.Currency = purchaseStruct?.Currency == null
//                    ? Currency.FirstOrDefault(objEx => objEx.Title == "ГРН")
//                    : Currency.FirstOrDefault(objEx => objEx.Id == purchaseStruct.Currency.Id);
//            }
//            PurchaseInfosViewModel temp = new PurchaseInfosViewModel
//            {
//                IdProduct = product.Id,
//                Currency = purchaseStruct.Currency,
//                IdCurrency = purchaseStruct.Currency.Id,
//                PurchasePrice = 0,
//                Count = 0,
//                Product = (Product)product.Clone(),
//                ExchangeRateOld = purchaseStruct.Currency,
//                PurchasePriceOld = purchaseStruct.PurchasePrice
//            };
//            if (purchaseInfo == null)
//            {
//                PurchaseInfos.AddAsync(temp);
//            }
//            else
//            {
//                purchaseInfo.Count++;
