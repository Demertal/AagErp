...
namespace WarrantyModul.ViewModels
{
    class AddWarrantyViewModel : ViewModelBase, IInteractionRequestAware
    {
        ...
        public AddWarrantyViewModel()
        {
            ...
            //AddWarrantyCommand = new DelegateCommand(AddWarrantyAsync).ObservesCanExecute(() => Warranty.IsValidate);
        }

        public async void AddWarrantyAsync()
        {
            try
            {
                ...
                //await dbSet.CreateAsync(Warranty.Warranty);
